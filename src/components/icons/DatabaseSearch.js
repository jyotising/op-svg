...
const SvgDatabaseSearch = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#database-search_svg__a)">
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M2 14c0 1.38 3.358 2.5 7.5 2.5.903 0 1.77-.053 2.572-.15M2 10c0 1.38 3.358 2.5 7.5 2.5 1.378 0 2.67-.124 3.78-.34M18.414 16.914 20.5 19M19 15.5c0 .552-.224 1.052-.586 1.414A2 2 0 1 1 19 15.5"
      />
    </g>
    <defs>
