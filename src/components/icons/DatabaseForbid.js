...
const SvgDatabaseForbid = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#database-forbid_svg__a)">
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M2 14c0 1.38 3.358 2.5 7.5 2.5.903 0 1.77-.053 2.572-.15M2 10c0 1.38 3.358 2.5 7.5 2.5 1.378 0 2.67-.124 3.78-.34M18.5 14l-3 3"
      />
    </g>
    <defs>
      <clipPath id="database-forbid_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgDatabaseForbid;
